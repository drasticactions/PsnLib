...
namespace PsnLib.Managers
{
    public class WebManager : IWebManager
    {
        ...
        public Task<Result> PutData(Uri uri, StringContent json, UserAccountEntity userAccountEntity)
        {
            throw new NotImplementedException();
        }

        public Task<Result> DeleteData(Uri uri, StringContent json, UserAccountEntity userAccountEntity)
        {
            throw new NotImplementedException();
        }
